package cn.gzticc.bgmanagertemplate.framework.utils;
...
//    private static String packageName="cn.gzticc.bgmanagertemplate.gen";    //文件路径
    ...
    private static String outFilePath = "src/main/";   //路径
    private static File file = new File(outFilePath);
...
//        tableFillList.add(new TableFill("ASDD_SS", FieldFill.INSERT_UPDATE));
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("123456")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/bgManagerTemplate?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()

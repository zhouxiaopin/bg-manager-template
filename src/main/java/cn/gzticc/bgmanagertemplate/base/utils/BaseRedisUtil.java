package cn.gzticc.bgmanagertemplate.base.utils;
...
/**
 * 基于spring和redis的getRedisTemplate()工具类
 * 针对所有的hash 都是以h开头的方法
...
public abstract class BaseRedisUtil {
     ...
     * @return 值
     */
    public List<Object> multiGet(Collection<String> key){
        return key==null?null:getRedisTemplate().opsForValue().multiGet(key);
    }
     ...
     * @return true成功 false失败
     */
    public boolean multiSet(Map<? extends String,?> map) {
        try {
